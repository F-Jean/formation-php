...
class Product extends \Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Product' . "\0" . 'id', '' . "\0" . 'Entity\\Product' . "\0" . 'name', '' . "\0" . 'Entity\\Product' . "\0" . 'description', '' . "\0" . 'Entity\\Product' . "\0" . 'priceET', '' . "\0" . 'Entity\\Product' . "\0" . 'vat', '' . "\0" . 'Entity\\Product' . "\0" . 'image', '' . "\0" . 'Entity\\Product' . "\0" . 'category', '' . "\0" . 'Entity\\Product' . "\0" . 'brand'];
        }
    ...
    public function getPriceET()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPriceET', []);

        return parent::getPriceET();
    }
    ...
    public function setPriceET($priceET)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPriceET', [$priceET]);

        return parent::setPriceET($priceET);
    }
    ...
    public function getPriceIT()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPriceIT', []);

        return parent::getPriceIT();
    }
